...
/*======================*/
	...
	(function($){
		...
		$('.project-social-link-share .social-links-share').on('click', function(){
				SocialLinksChild.each(function(){
	...
	(function($){
		...
		/*-----------------------*/
			...
			$('.post-gallery').flexslider({
				...
				pauseOnHover: true,
				allowOneSlide:false,
				prevText: "<span class='icon-arrow-left10'></a>",
				nextText: "<span class='icon-uniE91B'></a>",
			});
			...
			$(".nz-gallery.grid").each(function(){
				...
				imagesLoaded( $container, function() {
					$container.shuffle({
						...
						sizer:$container.find('.gallery-item'),
						gutterWidth:0,
						speed: 300,
						easing: 'ease-out' 
					});
...
/*======================*/
	...
	(function($){
        ...
        animateInView($('.nz-recent-projects.animate-fade'), $(".element-animate"),250);
        animateInView($('.nz-recent-products.animate-fade'), $(".element-animate"),250);

        animateInView($('.loop .animation-true .blog-post'),$(".post"),250);
        animateInView($('.loop .animation-true .projects-post'),$(".projects"),250);
        animateInView($('.loop .animation-true .products'),$(".product"),250);
